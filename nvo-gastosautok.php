...
$query = "DECLARE @IError int, 
        ...
        EXEC dbo.SP_AutorizaGastos @Id_Autorizacion = N'".$_GET['x1']."', @Mov = N'".$_GET['x2']."', @Respuesta = N'".$_GET['x3']."', @EmailSolicita = @EmailSolicita OUTPUT, @iError = @iError OUTPUT, @msg = @msg OUTPUT
