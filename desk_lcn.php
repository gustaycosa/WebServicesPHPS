          ...
          if($(window).width()<500){
              ...
              $(document).on('click touchstart','.list-group-item',function(){
                  if(timer == 0){
                      ...
                      contador = contador + 1;
                      var modal2 = "<iframe id='ifm"+IDFRM+"_"+contador+"' name='"+IDFRM+"' src='mod/"+modulo+"/"+IDFRM+".php?e="+<?php echo $Id_Usuario;?>+"&a=LINCOLN"+"' frameborder='0' class='col-sm-12 col-xs-12 col-md-12 col-lg-12'></iframe>";
