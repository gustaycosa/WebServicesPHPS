...
//print_r('http://ws.eimportacion.com.mx/tabla-reporte3.php?x1='.$suc.'&x2='.$fini.'&x3='.$ffin.'&x4='.$cliente.'&x5='.$estatus.'');
    //print_r('http://ws.eimportacion.com.mx/grafcobdiaria2.php?x1='.$suc.'&x2='.$mes.'&x3='.$ejercicio.'&x4='.$cliente.'&x5='.$estatus.'');
    echo file_get_contents('http://ws.eimportacion.com.mx/grafcobdiaria2.php?x1='.$suc.'&x2='.$fini.'&x3='.$ffin.'&x4='.$cliente.'&x5='.$estatus.'&x6='.$Empresa.'');
