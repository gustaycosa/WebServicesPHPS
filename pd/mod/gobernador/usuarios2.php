                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive row" style="margin-top: -21px !important;">
                            <table id='gridusers'  class='table table-striped table-bordered table-condensed table-hover display compact' cellspacing='0' style="width:100%;margin:0 auto;clear:both;border-collapse:collapse;table-layout:fixed;word-wrap:break-word;" >
                            </table>
                        </div>   
                    </div>
                </div>
