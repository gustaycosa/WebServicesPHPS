<?php
    ...
    //print_r($query);
    //print_r($myparams);
    echo file_get_contents('http://ws.eimportacion.com.mx/tabla-nvousuarios.php?x1='.$iopc.'&x2='.$id.'&x3='.$emp.'&x4='.$nomb.'&x5='.$us.'&x6='.$pass.'&x7='.$perfil.'&x8='.$grupo.'&x9='.$tel.'&x10='.$correo.'&x11='.$passc.'');
?>