...
$query = "DECLARE @IError int, 
        ...
        @sId_Empresa = N'".$_GET['x3']."',@sUsuario = N'".$_GET['x5']."',
        @sContrasena = N'".$_GET['x6']."',@sNombre = N'".$_GET['x4']."',@sTelefono = N'".$_GET['x7']."',
        @iId_Grupo = N'".$_GET['x8']."',@iId_Perfil = '".$_GET['x7']."',
        @sCorreo = N'".$_GET['x10']."',@sPassCorreo = N'".$_GET['x11']."',@sSucursal = N'".$_GET['x12']."',
