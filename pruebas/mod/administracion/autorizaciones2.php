...
$(document).ready(function() {
    ...
    var grid1 = {
            ...
            'createdRow': function (row,data,index){
                if( ! table.data().any()){   
                    $('#grid').dataTable().fnClearTable();
                    $('#grid tbody').append('<tr><td colspan="10" class="datatables_empty">Busqueda sin resultados.</td></tr>');
                }
                else{
                    ...
                    if( a == 'PENDIENTE'){
                        ...
                        $(row).children('td.autcn').text('AUTORIZAR');
                        $(row).children('td.autok').text('RECHAZAR');
                    }
