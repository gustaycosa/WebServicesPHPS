...
<?php echo Cabecera('CTA COSTOS ALMACEN REFACTURA VS CONTA');?>
<body>
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 id="cabecera">
            CTA COSTOS ALMACEN REFACTURA VS CONTA
        </h6>
    </div>
...
$(document).ready(function() {
    ...
    cabeceras1 = [
        ...
        { "title": "RENGLON", 'width':'40px', className: "text-left bg-warning", "targets": 4},
        { "title": "TIPO DOC GENERO", 'width':'60px', className: "text-center bg-warning", "targets": 5},
        { "title": "MOVIMIENTO GENERO", 'width':'90px', className: "text-right bg-warning", "targets": 6},
        { "title": "ARTICULO", 'width':'60px', className: "text-center bg-warning", "targets": 7},
        { "title": "NOMBRE", 'width':'220px', className: "text-left bg-warning", "targets": 8},
        { "title": "ENTRADA", 'width':'40px', className: "text-right bg-warning", "targets": 9},
        { "title": "SALIDA", 'width':'40px', className: "text-right bg-warning", "targets": 10},
        
        { "title": "COSTO NETO", 'width':'70px', className: "text-right bg-warning", "targets": 11},
        { "title": "DEBE ALMACEN", 'width':'70px', className: "text-right bg-warning", "targets": 12},
        { "title": "HABER ALMACEN", 'width':'70px', className: "text-right bg-warning", "targets": 13},
        { "title": "POLIZA", 'width':'140px', className: "text-right bg-danger", "targets": 14},
        { "title": "FECHA POLIZA", 'width':'60px', className: "text-right bg-danger", "targets": 15},
        
        { "title": "ID CUENTA", 'width':'80px', className: "text-right bg-danger", "targets": 16},
        { "title": "DEBE POLIZA", 'width':'70px', className: "text-right bg-danger", "targets": 17},
        { "title": "HABER POLIZA", 'width':'70px', className: "text-right bg-danger", "targets": 18},
        { "title": "DIF DEBE", 'width':'70px', className: "text-right", "targets": 19},
        { "title": "DIF HABER", 'width':'70px', className: "text-right", "targets": 20}
    ];
    var grid1 = {
            'columns': datos1,
...
/*                    var a = data.DebeAlmacen;
            ...
            "footerCallback": function ( row, data, start, end, display ) {
                ...
                // Update footer
                $( api_totalfact.column( 11 ).footer() ).html(numFormat(total_totalfact.toFixed(2)) );   
                ...
                // Update footer
                $( api_saldohoy.column( 12 ).footer() ).html(numFormat(total_saldohoy.toFixed(2)) );   
                ...
                // Update footer
                $( api_saldoafecha.column( 13 ).footer() ).html(numFormat(total_saldoafecha.toFixed(2)) );   
