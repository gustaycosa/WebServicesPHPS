...
<?php echo Cabecera('CTA COSTOS ALMACEN FACTURA VS CONTA');?>
<body>
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 id="cabecera">
            CTA COSTOS ALMACEN FACTURA VS CONTA
        </h6>
    </div>
...
$(document).ready(function() {
    ...
    cabeceras1 = [
        ...
        { "title": "MOVIMIENTO GENERO", 'width':'90px', className: "text-right bg-warning", "targets": 5},
