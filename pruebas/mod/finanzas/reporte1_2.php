...
var b = '';
    ...
    cabeceras1 = [
        ...
        { "title": "FECHA VENCE", 'width':'60px', className: "text-center", "targets": 6},
        { "title": "PAGO", 'width':'60px', className: "text-center", "targets": 7},
        { "title": "FOLIO", 'width':'60px', className: "text-center", "targets": 8},
        { "title": "FECHA PAGO", 'width':'60px', className: "text-right", "targets": 9},
        { "title": "FECHA AP.PAGO", 'width':'60px', className: "text-right", "targets": 10},
