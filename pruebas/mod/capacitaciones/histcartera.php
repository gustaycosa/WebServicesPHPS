...
$(document).ready(function() {
    ...
    cabeceras1 = [
        ...
        { "title": "FECHA FACT", 'width':'60px', className: "text-right", "targets": 9},
        { "title": "FECHA VENCE", 'width':'60px', className: "text-left", "targets": 10},
    ...
    var grid1 = {
            ...
            "footerCallback": function ( row, data, start, end, display ) {
                ...
                $("#td1-15").html(numFormat(total_totalfact.toFixed(2)));                
                 // Total over all pages
