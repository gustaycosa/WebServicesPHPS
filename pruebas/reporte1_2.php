...
<?php 
    ...
    Cabecera('Trayectoria de facturas');
?>
<body>
...
var b = '';
    ...
    cabeceras1 = [
        ...
        { "title": "ID CLIENTE", 'width':'150px', className: "text-left", "targets": 2},
        { "title": "CLIENTE", 'width':'60px', className: "text-left", "targets": 3},
        { "title": "FACTURA", 'width':'60px', className: "text-left", "targets": 4},
        { "title": "FECHA FACTURA", 'width':'60px', className: "text-center", "targets": 5},
        { "title": "PAGO", 'width':'60px', className: "text-cener", "targets": 6},
        { "title": "FECHA PAGO", 'width':'60px', className: "text-right", "targets": 7},
        { "title": "TOTAL FACTURA", 'width':'60px', className: "text-right", "targets": 8},
        { "title": "TOTAL PAGO", 'width':'60px', className: "text-left", "targets": 9},
        { "title": "SALDO FACTURA", 'width':'60px', className: "text-left", "targets": 10}
    ];
    var grid1 = {
            'columns': datos1,
