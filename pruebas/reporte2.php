...
$(document).ready(function() {
    ...
    cabeceras1 = [
        ...
        { "title": "TEL", 'width':'60px', className: "text-left", "targets": 2},
        { "title": "SUCURSAL", 'width':'60px', className: "text-left", "targets": 3},
        { "title": "FECHA", 'width':'60px', className: "text-cener", "targets": 4},
        { "title": "TIPO DOC.", 'width':'60px', className: "text-right", "targets": 5},
        { "title": "FOLIO", 'width':'60px', className: "text-left", "targets": 6},
        { "title": "SERIE", 'width':'60px', className: "text-right", "targets": 7},
        { "title": "VENCE", 'width':'60px', className: "text-center", "targets": 8},
        { "title": "TOTAL", 'width':'60px', className: "text-right", "targets": 9},
        { "title": "SALD DOC.", 'width':'60px', className: "text-right", "targets": 10},
        { "title": "MONEDA", 'width':'60px', className: "text-left", "targets": 11}
    ...
    var grid1 = {
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            // Update footer
            $( api_descuentos.column( 9 ).footer() ).html(numFormat(total_descuentos.toFixed(2)) );   
