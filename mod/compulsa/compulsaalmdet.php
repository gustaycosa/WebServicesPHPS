...
<?php echo Cabecera('COMPULSA CTA ALMACEN DETALLE');?>
<body>
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 id="cabecera">
            COMPULSA CTA ALMACEN DETALLE
        </h6>
    </div>
...
$(document).ready(function() {
    ...
    cabeceras1 = [
        { "title": "SUCURSAL", 'width':'80px',  "targets": 0},
        { "title": "FECHA", 'width':'60px', type: 'date-euro', "targets": 1},
        { "title": "TIPO", 'width':'60px',  "targets": 2},
        { "title": "MOVIMIENTO", 'width':'70px',  "targets": 3},
        { "title": "TIPO DOC GENERO", 'width':'40px',  "targets": 4},
        
        { "title": "MOVIMIENTO GENERO", 'width':'70px', className: "text-right", "targets": 5},
        { "title": "ARTICULO", 'width':'60px',  "targets": 6},
        { "title": "NOMBRE", 'width':'220px', className: "text-left", "targets": 7},
        { "title": "ENTRADA", 'width':'40px', className: "text-right", "targets": 8},
        { "title": "SALIDA", 'width':'40px', className: "text-right", "targets": 9},
        
        { "title": "COSTO NETO", 'width':'70px', className: "text-right", "targets": 10},
        ...
        { "title": "HABER POLIZA", 'width':'70px', className: "text-right", "targets": 17},
            ...
            buttons: [
                {
                    ...
                    bom: true,
                    text: 'CSV',
                    filename: '<?php echo "compulsaalm_".date('Y-m-d');?>',
                    extension: '.csv', 
                    exportOptions: {
                        columns: ':visible',
                        modifier: {
