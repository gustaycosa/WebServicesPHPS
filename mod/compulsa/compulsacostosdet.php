...
<?php echo Cabecera('COMPULSA CTA ALM DETALLE');?>
<body>
<div class="panel panel-default">
   <div class="panel-heading <?php $emp = $_GET["a"]; echo $emp;?>">
        <h6 id="cabecera">
            COMPULSA CTA COSTOS DETALLE
        </h6>
    </div>
...
$(document).ready(function() {
    ...
    cabeceras1 = [
        ...
        { "title": "ARTICULO", 'width':'60px', className: "text-center", "targets": 6},
            ...
            buttons: [
                {
                    ...
                    bom: true,
                    text: 'CSV',
                    filename: '<?php echo "compulsacostosdet_".date('Y-m-d');?>',
                    extension: '.csv', 
                    exportOptions: {
                        columns: ':visible',
                        modifier: {
