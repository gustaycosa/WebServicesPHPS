            ...
            <table id='gridtotales'  class='table table-striped table-bordered table-condensed table-hover display compact' cellspacing='0' style="width:100%;margin:0 auto;clear:both;border-collapse:collapse;table-layout:fixed;word-wrap:break-word;" >
                ...
                <tbody>
                    <tr>
                        ...
                        <td id="tdremanente" class="text-right"></td>
...
$(document).ready(function() {
    ...
    datos1 = [
        ...
        { data: "Id_Vendedor", 'width':'20px' },
        { data: "Vendedor", 'width':'180px' },
        { data: "Id_Cliente", 'width':'60px' },
        { data: "Cliente", 'width':'180px' },
        { data: "serie", 'width':'40px' },
        { data: "serieFiscal", 'width':'40px' },
        { data: "Folio", 'width':'30px' },
        { data: "concepto", 'width':'180px' },
        { data: "FechaFactura", 'width':'50px', type: 'date-euro' },
        { data: "FechaVence", 'width':'50px', type: 'date-euro' },
        { data: "dv", 'width':'30px' },
        { data: "dc", 'width':'30px' },
        { data: "TotalFactura", 'width':'70px' },
        { data: "SaldoHoy", 'width':'70px', 'visible':false},
        { data: "SaldoFechaEspecificada",'width':'70px'},
        { data: "remanente", 'width':'70px'},
        { data: "SinVencer", 'width':'70px'},
        { data: "1_15", 'width':'70px'},
        { data: "16_30", 'width':'70px'},
        { data: "31_45", 'width':'70px'},
        { data: "46_60", 'width':'70px'},
        { data: "61_90", 'width':'70px'},
        { data: "91_120", 'width':'70px'},
        { data: "Mayor_120", 'width':'70px' }
    ];
    cabeceras1 = [
        { "title": "SUCURSAL", 'width':'60px', className: "", "targets": 0},
        { "title": "ID", 'width':'20px', className: "", "targets": 1},
        { "title": "VENDEDOR", 'width':'180px', className: "", "targets": 2},
        { "title": "CLIENTE", 'width':'60px', className: "", "targets": 3},
        { "title": "NOMBRE CLIENTE", 'width':'180px', className: "", "targets": 4},
        { "title": "SERIE", 'width':'40px', className: "", "targets": 5},
        { "title": "SERIE FISCAL", 'width':'40px', className: "", "targets": 6},
        { "title": "FOLIO", 'width':'30px', className: "text-right", "targets": 7},
        { "title": "CONCEPTO", 'width':'180px', className: "", "targets": 8},
        { "title": "F.FACT", 'width':'50px', className: "", type: 'date-euro', "targets": 9},
        { "title": "F.VENCE", 'width':'50px', className: "", type: 'date-euro', "targets": 10},
        { "title": "DV", 'width':'30px', className: "text-right", "targets": 11},
        { "title": "DC", 'width':'30px', className: "text-right", "targets": 12},
        { "title": "TOTAL FACT", 'width':'70px', className: "text-right", "targets": 13},
        { "title": "SALDO HOY", 'width':'70px', className: "text-right", "targets": 14,'visible':false},
        { "title": "SALDO A FECHA", 'width':'70px', className: "text-right", "targets": 15},
        { "title": "REMANENTE", 'width':'70px', className: "text-right", "targets": 16},
        { "title": "SIN VENCER", 'width':'70px', className: "text-right", "targets": 17},
        { "title": "1-15", 'width':'70px', className: "text-right", "targets": 18},
        { "title": "16-30", 'width':'70px', className: "text-right", "targets": 19},
        { "title": "31-45", 'width':'70px', className: "text-right", "targets": 20},
        { "title": "46-60", 'width':'70px', className: "text-right", "targets": 21},
        { "title": "61-90", 'width':'70px', className: "text-right", "targets": 22},
        { "title": "91-120", 'width':'70px', className: "text-right", "targets": 23},
        { "title": "MAYOR-120", 'width':'70px', className: "text-right", "targets": 24}
    ];
    var grid1 = {
            'columns': datos1,
            ...
            "footerCallback": function ( row, data, start, end, display ) {
                ...
                var api_remanente = this.api(), data;
                ...
                // Update footer
                $( api_remanente.column( 16 ).footer() ).html(numFormat(total_remanente.toFixed(2)) ); 
                $("#tdremanente").html(numFormat(total_remanente.toFixed(2)));
                ...
                // Update footer
                $( api_sinvencer.column( 17 ).footer() ).html(numFormat(total_sinvencer.toFixed(2)) );
                ...
                // Update footer
                $( api_1_15.column( 18 ).footer() ).html(numFormat(total_1_15.toFixed(2)) );  
                ...
                // Update footer
                $( api_16_30.column( 19 ).footer() ).html(numFormat(total_16_30.toFixed(2)) );  
                ...
                // Update footer
                $( api_31_45.column( 20 ).footer() ).html(numFormat(total_31_45.toFixed(2)) );  
                ...
                // Update footer
                $( api_46_60.column( 21 ).footer() ).html(numFormat(total_46_60.toFixed(2)) );  
                ...
                // Update footer
                $( api_61_90.column( 22 ).footer() ).html(numFormat(total_61_90.toFixed(2)) );  
                ...
                // Update footer
                $( api_91_120.column( 23 ).footer() ).html(numFormat(total_91_120.toFixed(2)) ); 
                ...
                // Update footer
                $( api_mayor120.column( 24 ).footer() ).html(numFormat(total_mayor120.toFixed(2)) ); 
