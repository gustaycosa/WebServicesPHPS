...
<head>
<title id="title">Trayectoria de facturas</title>
    <meta charset=utf-8>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form id="formulario" method="POST" class="form-inline">
            <input type="hidden" class="form-control" id="TxtRow" name="TxtClave" value="0" > 
...
var b = '';
    datos1 = [
        ...
        { data: "fechavence", type: 'date-euro' },
    ...
    cabeceras1 = [
        ...
        { "title": "ID", 'width':'60px', className: "text-left", "targets": 1},
        { "title": "NOMBRE", 'width':'150px', className: "text-left", "targets": 2},
        { "title": "TIPO DOC.", 'width':'60px', className: "text-left", "targets": 3},
        { "title": "CLAVE DOC.", 'width':'60px', className: "text-left", "targets": 4},
        { "title": "FECHA", 'width':'60px', className: "text-center", type: 'date-euro', "targets": 5},
        { "title": "VENCE", 'width':'60px', className: "text-cener", type: 'date-euro', "targets": 6},
        { "title": "TOTAL", 'width':'60px', className: "text-right", "targets": 7},
        { "title": "PENDIENTE", 'width':'60px', className: "text-right", "targets": 8},
        { "title": "APLICO", 'width':'60px', className: "text-left", "targets": 9},
        { "title": "DOCUMENTO", 'width':'60px', className: "text-left", "targets": 10},
        { "title": "TOTAL PAGO", 'width':'60px', className: "text-right", "targets": 11},
        { "title": "REMANENTE", 'width':'60px', className: "text-right", "targets": 12}
    ];
    var grid1 = {
            'columns': datos1,
            ...
            'createdRow': function (row,data,index){
                ...
                $('#grid1').dataTable().fnClearTable();
                    ...
                    var b = '';
                    var a = data.Documento;
                    $(row).attr({ id:a+b,});
                    if( a != 'PAGO'){
                        $(row).children('td.total').text('-----');
                    }
                }
            },
            dom: 'lfBrtip', 
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api_facturado.column( 7 ).footer() ).html(numFormat(total_facturado.toFixed(2)) );
            ...
            // Update footer
            $( api_devolucion.column( 11 ).footer() ).html(numFormat(total_devolucion.toFixed(2)) );      
            ...
            // Update footer
            $( api_drefacturacion.column( 12 ).footer() ).html(numFormat(total_drefacturacion.toFixed(2)) );   
