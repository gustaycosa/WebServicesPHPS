...
$(document).ready(function() {
    ...
    cabeceras1 = [
        ...
        { "title": "SALDO HOY", 'width':'70px', className: "text-right", "targets": 14},
        { "title": "SALDO A FECHA", 'width':'70px', className: "text-right", "targets": 15},
        { "title": "SIN VENCER", 'width':'70px', className: "text-right", "targets": 16},
        { "title": "1-15", 'width':'70px', className: "text-right", "targets": 17},
        { "title": "16-30", 'width':'70px', className: "text-right", "targets": 18},
        { "title": "31-45", 'width':'70px', className: "text-right", "targets": 19},
        { "title": "46-60", 'width':'70px', className: "text-right", "targets": 20},
        { "title": "61-90", 'width':'70px', className: "text-right", "targets": 21},
        { "title": "91-120", 'width':'70px', className: "text-right", "targets": 22},
        { "title": "MAYOR-120", 'width':'70px', className: "text-right", "targets": 23}
    ];
    var grid1 = {
            'columns': datos1,
