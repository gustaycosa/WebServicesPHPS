 ...
 */   
 echo '<body class="body">
 <div id="navmenu" style="left: 0px;">
   <ul class="nav navmenu-nav" style="background:black;">
      <li id="a34">
         <a id="VENTAS" type="button">
         VENTAS</a>
         <ul class="VENTAS">
            <li id="35"><a id="curso1" target="curso1.php?id=10&no=alberto1" class="list-item" style="display:block;padding:10px;">ISOCLEAN MODULO 1</a></li>
         </ul>
      </li>
      <li><a href="salir.php" type="button" class="list-item">
         <span class="glyphicon glyphicon-off" aria-hidden="true"></span> Cerrar sesión
 ...
 ?>
    <script type="text/javascript"> 
        ...
        $(document).on('click touchstart','.list-group-item',function(){
            ...
            contador = contador + 1;
            var modal2 = "<iframe id='ifm"+IDFRM+"_"+contador+"' name='"+IDFRM+"' src='mod/"+modulo+"/"+IDFRM+".php' frameborder='0' class='col-sm-12 col-xs-12 col-md-12 col-lg-12'></iframe>";
        ...
        $(document).on('click touchstart','.list-item',function(){
            ...
            contador = contador + 1;
            var modal2 = "<iframe id='ifm"+IDFRM+"' name='"+IDFRM+"' src='"+IDFRM+".php?id=10&no=alberto1' frameborder='0' class='col-sm-12'></iframe>";
