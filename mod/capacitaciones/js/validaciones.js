...
var Validate = {
    Presence: function(B, C) {
        var C = C || {};
        var A = C.failureMessage || "Este campo es necesario";
    ...
    Numericality: function(J, E) {
        ...
        var G = E.notANumberMessage || "Debe ser un numero";
        var H = E.notAnIntegerMessage || "Debe ser un entero!";
        var I = E.wrongNumberMessage || "Must be " + D + "!";
        var B = E.tooLowMessage || "Debe tener al menos" + F + "!";
        var K = E.tooHighMessage || "No debe tener mas de " + C + "!";
        if (!isFinite(J)) {
            Validate.fail(G);
        }
    ...
    Email: function(B, C) {
        var C = C || {};
        var A = C.failureMessage || "Se necesita una dirección de correo";
        Validate.Format(B, {
            failureMessage: A,
    ...
    Length: function(F, G) {
        ...
        var A = G.wrongLengthMessage || "Deben ser " + C + " caracteres";
        var B = G.tooShortMessage || "Debe tener al menos " + E + " caracteres";
        var D = G.tooLongMessage || "No debe tener mas de " + H + " caracteres";
        switch (true) {
            case (C !== null):
    ...
    Confirmation: function(C, D) {
        ...
        var D = D || {};
        var B = D.failureMessage || "No coincide con el  campo anterior";
