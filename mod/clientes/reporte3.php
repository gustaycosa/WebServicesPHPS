...
$(document).ready(function() {
    ...
    cabeceras1 = [
        { "title": "FECHA", 'width':'20px', className: "text-center", "targets": 0},
        { "title": "ID", 'width':'20px', className: "text-center", "targets": 1},
        { "title": "NOMBRE", 'width':'180px', className: "text-left", "targets": 2},
        { "title": "TIPO DOC.", 'width':'20px', className: "text-center", "targets": 3},
        { "title": "FOLIO", 'width':'20px', className: "text-center", "targets": 4},
        { "title": "SUCURSAL", 'width':'50px', className: "text-left", "targets": 5},
        { "title": "CONCEPTO", 'width':'70px', className: "text-left", "targets": 6},
        { "title": "TPTAL", 'width':'50px', className: "text-right", "targets": 7},
        { "title": "MONEDA", 'width':'20px', className: "text-right", "targets": 8},
        { "title": "MONEDA", 'width':'20px', className: "text-right", "targets": 9},
        { "title": "ESTATUS", 'width':'20px', className: "text-right", "targets": 10}
    ];
    var grid1 = {
            'columns': datos1,
