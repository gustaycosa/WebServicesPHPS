...
<html class="no-js">
   <?php 
      ...
      $myparams['sTipoPerfil'] = 'EXCLUYENTE';
      ...
      $query = "EXEC dbo.GOB_SP_Menu_Accesos @sPerfil = '".$_GET['x4']."', @sModulo = 'DWH', @sTipoPerfil = '".$_GET['x3']."'";
      ...
      //style="background:url(images/back01.gif) center center no-repeat fixed white;background-size:cover;
          ...
          echo '<body class="body">
              <div id="navmenu">
                <ul class="nav navmenu-nav" style="background:red;">';
          $BANDERA = '';
          $i = 0;
          while( $row = sqlsrv_fetch_array($cadena)) {
              ...
              z-index: 2;"></div>
                  ...
                  echo '<div id="principal" class="container-fluid"><div id="logo" style="width: 200px;height: 200px;background: url(images/logo.png) no-repeat center;position: fixed;background-size: contain;top: 5%;right: 5%;"></div></div></body>';
          echo'<style>
   ...
   <script type="text/javascript"> 
      ...
      $(document).ready(function() {
          ...
          if($(window).width()<500){
              //alert('La resolucion es menor '+ $(window).width());
          ...
          if($(window).width()>=500){
              //alert('La resolucion es mayor '+ $(window).width());
              $(document).on('click touchstart','.close',function(){
                      var ID = $( this ).attr("name");
                      $( "#navbar #"+ID ).remove();
                      $( "#ifm"+ID ).remove();            
