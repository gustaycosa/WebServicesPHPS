 ...
 ?>
    <script type="text/javascript"> 
        ...
        $(document).on('click touchstart','.list-group-item',function(){
            ...
            contador = contador + 1;
            var modal2 = "<iframe id='ifm"+IDFRM+"_"+contador+"' name='"+IDFRM+"' src='mod/"+modulo+"/"+IDFRM+".php?e="+<?php echo $Id_Usuario;?>+"&a="+<?php echo $id_empresa;?>+"' frameborder='0' class='col-sm-12 col-xs-12 col-md-12 col-lg-12'></iframe>";
        ...
        $(document).on('click touchstart','.list-item',function(){
            ...
            contador = contador + 1;
            var modal2 = "<iframe id='ifm"+IDFRM+"' name='"+IDFRM+"' src='"+IDFRM+".php?e="+<?php echo $Id_Usuario;?>+"&a="+<?php echo $id_empresa;?>+"' frameborder='0' class='col-sm-12'></iframe>";
